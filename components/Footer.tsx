...
export function Footer() {
  return (
    <footer className="bg-[#050b14] text-gray-400 py-16 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-sm leading-relaxed">
            Международный логистический оператор и экспедитор. Организуем и
            сопровождаем международные поставки из Китая, стран Азии и Европы.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 pt-8 border-t border-gray-800">
        <p className="text-xs text-gray-500 text-center mb-4 leading-relaxed max-w-4xl mx-auto">
          SLGC TRANS осуществляет деятельность в качестве логистического
          оператора и экспедитора. Перевозка грузов и таможенное оформление
          выполняются привлечёнными перевозчиками и таможенными представителями,
