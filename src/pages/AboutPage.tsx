...
export function AboutPage() {
  return <div className="pt-20">
      ...
      <section className="bg-[#1a2332] py-20 relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1494412574643-35d324698420?ixlib=rb-4.0.3&auto=format&fit=crop&w=2064&q=80')] bg-cover bg-center opacity-10" />
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          duration: 0.6
            ...
            <p className="text-xl text-gray-400 max-w-2xl">
              Международный логистический оператор, специализирующийся на организации
              и сопровождении международных перевозок.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            <div>
              ...
              <div className="space-y-4 text-gray-300 leading-relaxed">
                <p>
                  ...
                  специализирующийся на организации и сопровождении международных
                  перевозок, а также координации таможенных и внешнеэкономических
                  процессов.
                </p>
                <p>
                  ...
                  представителей, обеспечивая централизованное управление поставкой
                  и контроль ключевых параметров.
                </p>
                <p>
                  Наша цель — стабильность поставок, прозрачность процессов
                  и предсказуемый результат для клиента. Подходим для бизнеса
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-2xl border border-gray-700">
              <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1566576912902-1d6db6e8d35a?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80')] bg-cover bg-center" />
            </div>
          </div>
